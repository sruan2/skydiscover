...
while maximizing the sum of their radii. The benchmark metric is:

```text
combined_score = sum_of_radii
```
...
- the same target reference value, with raw sum-of-radii reporting;
